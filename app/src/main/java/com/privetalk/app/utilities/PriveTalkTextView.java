 ...
 */
public class PriveTalkTextView extends TextView {
    ...
    private AsyncTask<Void, Void, Void> fetchInBackground;

    public PriveTalkTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PriveTalkTextView(Context context, AttributeSet attrs, int defStyle) {
