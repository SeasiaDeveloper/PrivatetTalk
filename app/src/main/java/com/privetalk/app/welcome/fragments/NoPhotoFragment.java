...
public class NoPhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_no_photo, container, false);


        title = rootView.findViewById(R.id.titleNoPhoto);
        message = rootView.findViewById(R.id.messageNoPhoto);
        image = rootView.findViewById(R.id.imageNoPhoto);
