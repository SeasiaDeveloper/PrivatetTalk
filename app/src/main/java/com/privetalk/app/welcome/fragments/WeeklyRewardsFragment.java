 ...
 */
public class WeeklyRewardsFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView =  inflater.inflate(R.layout.fragment_weekly_personality_rewards, container, false);

        title = rootView.findViewById(R.id.titleWeekly);
        message = rootView.findViewById(R.id.messageWeekly);
        image = rootView.findViewById(R.id.imageWeekly);
