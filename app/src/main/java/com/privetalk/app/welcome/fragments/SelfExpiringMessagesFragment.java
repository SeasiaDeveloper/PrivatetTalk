 ...
 */
public class SelfExpiringMessagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_self_expiring_messages, container, false);

        title = rootView.findViewById(R.id.titleSelf);
        message = rootView.findViewById(R.id.messageSelf);
        image = rootView.findViewById(R.id.imageSelf);
